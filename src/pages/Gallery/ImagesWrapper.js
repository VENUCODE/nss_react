    ...
    <div className="mx-0">
      ...
      <div className="my-3">
        <div className="w-100  heading m-0 ">
          <span className=" ff-p fs-4 fw-bold text-capitalize">
            {event_name}
          </span>
        ...
        <div className="container-fluid   d-flex flex-row flex-wrap mt-2 w-100 ">
          {[...images, ...images, ...images]?.map((image, id) => (
            <Image
              ...
              className="card m-1 rounded-0 img-fluid border-0 "
              style={{
                height: "150px",
                width: "250px",
                objectFit: "cover",
